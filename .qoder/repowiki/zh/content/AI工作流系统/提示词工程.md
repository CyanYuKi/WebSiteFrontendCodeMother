...
## 更新摘要
**变更内容**
- 提示词工程从Vue生成模板更新为HTML生成模板
- 新增设计概念生成器专用提示词模板
- 支持多文件HTML页面生成和块级补丁修复
- 代码审查系统从Vue审查更新为HTML审查
...
- [HtmlGenerator.java:17-271](file://src/main/java/com/example/websitemother/node/HtmlGenerator.java#L17-L271)
- [CodeReviewer.java:17-233](file://src/main/java/com/example/websitemother/node/CodeReviewer.java#L17-L233)
- [PromptTemplates.java:7-229](file://src/main/java/com/example/websitemother/prompt/PromptTemplates.java#L7-L229)
...
- [PromptTemplates.java:212-227](file://src/main/java/com/example/websitemother/prompt/PromptTemplates.java#L212-L227)
...
- **示例路径**
  ...
  - HTML 生成器系统提示词：[PromptTemplates.java:101-169](file://src/main/java/com/example/websitemother/prompt/PromptTemplates.java#L101-L169)
  - 代码审查系统提示词：[PromptTemplates.java:212-227](file://src/main/java/com/example/websitemother/prompt/PromptTemplates.java#L212-L227)
- **改进建议**
...
## 结论
WebsiteMother 的提示词工程系统通过 PromptTemplates 将提示词标准化、参数化与版本化，结合 LangGraph4j 的工作流编排，实现了从意图识别到 HTML 代码生成的自动化闭环。系统现已从 Vue 生成模板升级为 HTML 生成模板，新增设计概念生成器，支持多文件生成和块级补丁修复，显著提升了生成质量和系统表现。建议在现有基础上进一步完善模板版本管理、输出格式校验与 A/B 测试体系，持续提升生成质量与用户体验。
